...
function MiniStat({
  ...
  return (
    <div className="rounded-xl border border-canvas-line bg-canvas px-4 py-3 dark:border-navy-700 dark:bg-navy-800">
      <p className="text-2xs font-medium uppercase tracking-wider text-tertiary">
        {label}
      </p>
...
function Bar({ height, delay, active }: BarProps) {
  return (
    <motion.div
...
function LineChart({
  ...
  const paths: Record<string, string> = {
    revenue:
      'M0,140 C40,120 80,60 120,80 C160,100 200,40 240,50 C280,60 320,20 360,30',

    occupancy:
      'M0,120 C40,130 80,90 120,100 C160,110 200,70 240,80 C280,90 320,50 360,60',

    bookings:
      'M0,100 C40,80 80,110 120,90 C160,70 200,100 240,60 C280,40 320,70 360,40',

    pricing:
      'M0,80 C40,100 80,60 120,70 C160,80 200,40 240,50 C280,60 320,30 360,20',
  };

  const path = paths[variant] ?? paths.revenue;
...
export function DashboardMockup({
  ...
  return (
    <div
      className={`surface relative overflow-hidden rounded-4xl shadow-glow ${className}`}
    >
      {/* Browser Header */}
      ...
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-[1.6fr_1fr]">
          ...
          <div className="rounded-xl border border-canvas-line bg-canvas p-4 dark:border-navy-700 dark:bg-navy-800">
            <div className="flex items-center justify-between">
              <p className="text-2xs font-semibold uppercase tracking-wider text-tertiary">
                Performance
              </p>
